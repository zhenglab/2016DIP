		...
		{  
           ...
           for(int k = 0;k < r;k++)                                             
           {
              ...
              {                                        
                ...
                dstimage2.at<Vec3b>(k,w)[0] = 3*sum.val[0]/(r*c)*srcimage.at<Vec3b>(k,w)[0];          
                dstimage2.at<Vec3b>(k,w)[1] = 3*sum.val[1]/(r*c)*srcimage.at<Vec3b>(k,w)[1];          
                dstimage2.at<Vec3b>(k,w)[2] = 3*sum.val[2]/(r*c)*srcimage.at<Vec3b>(k,w)[2];          
