...
int main()
{
    ...
    Mat srcimage1 = imread("50noise.jpg");
    Mat srcimage2 = imread("100noise.jpg");
    Mat srcimage3 = imread("150noise.jpg");
    Mat srcimage4 = imread("200noise.jpg");
    Mat srcimage5 = imread("250noise.jpg");
